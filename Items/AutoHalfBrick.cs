...
{
    public class AutoHalfBrick : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Brass Stepper");
            Tooltip.SetDefault("Hammers tiles into steps\n<right> to remove steps");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.width = 20;
            item.height = 20;
            item.shoot = mod.ProjectileType<Projectiles.AutoHalfBrick>();
